                ...
                <Suspense fallback={<Loading />}>
                  <Routes>
                    <Route path="/" element={<Layout />}>
                      ...
                      <Route path="paybycash" element={<ProtectedRoute><PayByCash /></ProtectedRoute>} />
                      <Route path="paybyonline" element={<ProtectedRoute><PayByOnline /></ProtectedRoute>} />
                      <Route path="productdetails/:id" element={<ProtectedRoute><ProductDetails /></ProtectedRoute>} />
                      <Route path="categorydetails/:id" element={<ProtectedRoute><CategoryDetails /></ProtectedRoute>} />
                      <Route path="brandDetails/:id" element={<ProtectedRoute><BrandDetails /></ProtectedRoute>} />
                      <Route path="AddressCheckoutForm" element={<ProtectedRoute><AddressCheckoutForm /></ProtectedRoute>} />
